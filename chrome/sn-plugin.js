...
// (C) 2012 Oleg Vaskevich, Nathan Heaps, Peiling Ding, Northeastern University
...
(function ($) {
    // make sure we're on the print page
    if (!document.location.href.match(/service-now\.com.*sysparm_media=print.*/g))
		return;
	
    // get the incident number
    sn_rrc_incident = document.getElementById("sys_readonly.incident.number").value;
    sn_rrc_caller = document.getElementById("incident.caller_id_label").value;
    ...
    $("div.print_hide").append('<button type="submit" id="snBcPrintLabels" onClick="printLabel();">\
